        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="primary_menu">
                ...
                <div class="right-button hidden-xs">
                    <a href="<?php echo base_url('auth');?>">Sign Up</a>
                </div>
            </div>
        </div>
    </nav>
            ...
            <div class="row">
                <div class="col-xs-12 hidden-sm col-md-5">
                    <figure class="mobile-image wow fadeInUp" data-wow-delay="0.2s">
                        <img src="<?php echo base_url()?>assets/images/header-mobile.png" alt="">
                    </figure>
                </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-md-10 col-md-offset-1">
                    <div class="page-title text-center">
                        <img src="<?php echo base_url()?>assets/images/Logo1.png" alt="Logo" style="max-width:70%;">
                        <div class="space-20"></div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="hidden-xs hidden-sm col-md-4">
                    <figure class="mobile-image">
                        <img src="<?php echo base_url()?>assets/images/feature-image.png" alt="Feature Photo">
                    </figure>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="service-box wow fadeInUp" data-wow-delay="0.2s">
                    ...
                    <div class="team-slide">
                        <div class="team-box">
                            <div class="team-image">
                                <img src="<?php echo base_url()?>assets/images/Herwin.png" alt="">
                            </div>
                        ...
                        <div class="team-box">
                            <div class="team-image">
                                <img src="<?php echo base_url()?>assets/images/Syifa.png" alt="">
                            </div>
                        ...
                        <div class="team-box">
                            <div class="team-image">
                                <img src="<?php echo base_url()?>assets/images/nurul1.png" alt="">
                            </div>
                            <h4>Nurul Azizah</h4>
                        ...
                        <div class="team-box">
                            <div class="team-image">
                                <img src="<?php echo base_url()?>assets/images/Dian.png" alt="">
                            </div>
                            <h4>Dian Agustin</h4>
                        ...
                        <div class="team-box">
                            <div class="team-image">
                                <img src="<?php echo base_url()?>assets/images/Ica.png" alt="">
                            </div>
                        ...
                        <div class="team-box">
                            <div class="team-image">
                                <img src="<?php echo base_url()?>assets/images/novan1.png" alt="">
                            </div>
                            <h4>Novan Tiano</h4>
                        ...
                        <div class="team-box">
                            <div class="team-image">
                                <img src="<?php echo base_url()?>assets/images/Pipit.png" alt="">
                            </div>
                        ...
                        <div class="team-box">
                            <div class="team-image">
                                <img src="<?php echo base_url()?>assets/images/kang jef.png" alt="">
                            </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 gallery-slider">
                    <div class="gallery-slide">
                        <div class="item"><img src="<?php echo base_url()?>assets/images/gallery-1.jpg" alt=""></div>
                        <div class="item"><img src="<?php echo base_url()?>assets/images/gallery-2.jpg" alt=""></div>
                        <div class="item"><img src="<?php echo base_url()?>assets/images/gallery-3.jpg" alt=""></div>
                        <div class="item"><img src="<?php echo base_url()?>assets/images/gallery-4.jpg" alt=""></div>
                        <div class="item"><img src="<?php echo base_url()?>assets/images/gallery-1.jpg" alt=""></div>
                        <div class="item"><img src="<?php echo base_url()?>assets/images/gallery-2.jpg" alt=""></div>
                        <div class="item"><img src="<?php echo base_url()?>assets/images/gallery-3.jpg" alt=""></div>
                        <div class="item"><img src="<?php echo base_url()?>assets/images/gallery-1.jpg" alt=""></div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-6">
                    ...
                    <div class="desc wow fadeInUp" data-wow-delay="0.6s">
                        <p>UKM Creative Student Association dikelompokkan dalam dua divisi, yaitu divisi pemrograman dan
                            divisi multimedia.</p>
                        <img src="<?php echo base_url()?>assets/images/LOGO PEMRO FIX.png" style="max-width: 100px">
                        <img src="<?php echo base_url()?>assets/images/logo mm.png" style="max-width: 90px">
                    </div>
                    <div class="space-50"></div>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-5 col-md-offset-1">
                    ...
                    <div class="service-box wow fadeInUp" data-wow-delay="0.2s">
                        <div class="box-icon">
                            <img src="<?php echo base_url()?>assets/images/pemrograman.png">
                        </div>
                        <h4>Pemrograman</h4>
                    ...
                    <div class="service-box wow fadeInUp" data-wow-delay="0.2s">
                        <div class="box-icon">
                            <img src="<?php echo base_url()?>assets/images/Multimedia.png">
                        </div>
                        <h4>Multimedia</h4>
